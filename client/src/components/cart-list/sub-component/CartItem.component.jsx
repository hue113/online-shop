...
const CartItem = ({
  ...
  return (
    <>
      <div className="cart-item row d-flex flex-wrap mx-2 my-5">
        ...
        <div className="item-total bold align-self-end ml-auto">
          ${calculatePrice(price, discount, quantity)}
        </div>

        <i
          className="bi bi-trash remove-icon icon"
